...
# 💫 About Me:
Hi! I'm a passionate **Software Engineer** with expertise in **Full Stack Development** and **DevOps**. I enjoy solving complex problems, contributing to innovative projects, and building scalable web solutions.

---

## 👯 I’m Looking to Collaborate On
- 🚀 **Open Source Projects** to learn, contribute, and grow together.
- 🛠 **Web Applications** leveraging modern technologies and best practices.
...
## 💬 Ask Me About
- ⚛️ **React** and **Next.js** for creating modern front-end applications.
- 🔧 **DevOps Practices** like CI/CD pipelines, Docker, Kubernetes, and cloud deployments.
- 🌐 **Backend Development** and API design for scalable architectures.
